  ...
  return (
    <GlassPanel className="p-5 sm:p-6">
      ...
      <textarea
        ...
        className="mt-5 min-h-36 w-full resize-none rounded-3xl border border-white/12 bg-slate-950/35 p-4 text-base leading-7 text-white outline-none transition placeholder:text-slate-400/70 focus:border-cyan-300/70 focus:bg-slate-950/45 focus:shadow-[0_0_32px_rgba(34,211,238,0.14)] focus:ring-4 focus:ring-cyan-300/10"
      />
      ...
      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
        ...
        <button
          ...
          onClick={() => fileInputRef.current?.click()}
          disabled={uploading}
          className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/12 bg-white/[0.055] px-5 py-3 font-semibold text-white transition hover:-translate-y-0.5 hover:bg-white/[0.1] active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60"
        >
